...
all: sender receiver client server # sender2 receiver2 
...
tarball:
	cd .. ; tar cfz sockets.tar.gz sockets/{{sender,receiver,client,server}.cpp,{Socket,Worker}.{cpp,h},Makefile.sockets}
